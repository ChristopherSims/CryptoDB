...
from cryptodb.crypto.ciphers import Cipher, cipher_factory
...
class EnvelopeCipher:
    ...
    def encrypt(
        ...
        dek = cipher_factory(cipher_name, b"").generate_key()
        cipher: Cipher = cipher_factory(cipher_name, dek)
    ...
    def decrypt(self, envelope: Envelope) -> bytes:
        ...
        try:
            cipher: Cipher = cipher_factory(envelope.cipher_name, dek)
